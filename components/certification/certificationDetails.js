              ...
              <div className="blog-details-desc">
                <div className="article-content">
                  ...
                  <div className="article-image">
                    <img src="/images/logos_icontec.png" alt="image" />
                  </div>

                  <h3>Politicas de gestión integral</h3>
                  <p>
                    Con el objeto de enfocar su gestión Ceter ha desarrollado
                    las siguientes políticas:
                  </p>
                  <CertificationPolitics text="Política Integral HSEQ - BASC" />
                  <CertificationPolitics text="Política para la Seguridad Vial" />
                  <CertificationPolitics text="Política de Convivencia Laboral." />
                  <CertificationPolitics text="Política de No Alcohol, Drogas y Tabaco." />
                  <CertificationPolitics text="Política seguridad Informatica." />
                  <CertificationPolitics text="Política de Control Vehicular por Sobrepeso." />
                  <CertificationPolitics text="Política de Confidencialidad y Seguridad." />
                  <CertificationPolitics text="Política Anticorrupción." />
                  <CertificationPolitics
                    text="Política de protección de datos personales."
                    link="/assets/politicaproteccion.pdf"
                  />
                  <CertificationPolitics
                    text="Políticas para La Administración Del Riesgo SIPLAF."
                    link="/assets/politicasiplaf.pdf"
                  />
                </div>
              </div>
            </div>
